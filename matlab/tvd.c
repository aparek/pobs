 ...
 *
 * This is a mex wrapper for the C program for fast exact TV denoising by Laurent Condat.
 * A mex wrapper allows a C program to be compiled for use in MATLAB. 
 *
 * Reference:
 * L. Condat. A direct algorithm for 1-D total variation denoising.
 * IEEE Signal Processing Letters, 20(11):1054–1057, November 2013.
 *
 * http://www.gipsa-lab.grenoble-inp.fr/~laurent.condat/
 *
 * Mex wrapper by Faruk UYSAL, June 2012
 *
 */
