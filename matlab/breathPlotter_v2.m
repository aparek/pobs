function [y, curResults] = breathPlotter_v2(filename)
...
try
    ...
    y = T.FlowAvgMid3rdPercentNormal(T.FlowAvgMid3rdPercentNormal < 2) * 100;
    ...
    if shadingNew
        ...
        histCounts = hist_counts'/sum(hist_counts);
        % 0-20
        for k = 1:20/5
    ...
    figure(1)
    text(10,1/100,sprintf('%.0f%%',ceil(abs(val20) * 100)),'FontSize',16,'HorizontalAlignment','Center')
    text(60,1.5/100,sprintf('%.0f%%',abs(val70-val50) * 100),'FontSize',16,'HorizontalAlignment','Center')
    text(100,3/100,sprintf('%.0f%%',abs(val130-val70) * 100),'FontSize',16,'HorizontalAlignment','Center')
    text(165,1.5/100,sprintf('%.0f%%',abs(1-val130) * 100),'FontSize',16,'HorizontalAlignment','Center')
